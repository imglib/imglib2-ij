...
public class KDTreeImplFlat
{
    ...
    KDTreeImplFlat(final double[] positions, final int numDimensions) {
    ...
    public class Node implements RealLocalizable {
        ...
        public double getDoublePosition(final int d) {
            return KDTreeImplFlat.this.getDoublePosition(i, d);
        }
    ...
    public class NearestNeighborSearch {
        ...
        public void search(final RealLocalizable p) {
            ...
            int bestIndexL = -1;
            while (true) {
                final double distance = KDTreeImplFlat.this.squDistance(current, pos);
                ...
                final double axisDiff = pos[d] - KDTreeImplFlat.this.getDoublePosition(current, d);
